...
{
    /// <summary> The ApplyUpdateCollectionExistsOptions. </summary>
    public partial class ApplyUpdateCollectionExistsOptions
    {
        /// <summary> Initializes a new instance of ApplyUpdateCollectionExistsOptions. </summary>
        ...
        public ApplyUpdateCollectionExistsOptions(string providerName, string resourceParentType, string resourceParentName, string resourceType, string resourceName, string applyUpdateName)
        {
