...
{
    public partial class ConfigurationAssignmentData : IUtf8JsonSerializable
    {
        ...
        internal static ConfigurationAssignmentData DeserializeConfigurationAssignmentData(JsonElement element)
        {
            ...
            return new ConfigurationAssignmentData(id, name, type, systemData.Value, Optional.ToNullable(location), Optional.ToDictionary(extensionProperties), maintenanceConfigurationId.Value, resourceId.Value, Optional.ToList(resourceTypes), Optional.ToList(resourceGroups), Optional.ToList(locations), tagSettings.Value);
        }
    }
}
