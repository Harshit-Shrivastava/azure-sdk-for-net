...
namespace Azure.ResourceManager.Maintenance
{
    ...
    public partial class ConfigurationAssignmentCollection : ArmCollection, IEnumerable<ConfigurationAssignmentResource>, IAsyncEnumerable<ConfigurationAssignmentResource>
    {
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _configurationAssignmentRestClient.CreateListParentRequest(Id.SubscriptionId, Id.ResourceGroupName, _providerName, _resourceParentType, _resourceParentName, _resourceType, _resourceName);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new ConfigurationAssignmentResource(Client, ConfigurationAssignmentData.DeserializeConfigurationAssignmentData(e)), _configurationAssignmentClientDiagnostics, Pipeline, "ConfigurationAssignmentCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _configurationAssignmentRestClient.CreateListParentRequest(Id.SubscriptionId, Id.ResourceGroupName, _providerName, _resourceParentType, _resourceParentName, _resourceType, _resourceName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new ConfigurationAssignmentResource(Client, ConfigurationAssignmentData.DeserializeConfigurationAssignmentData(e)), _configurationAssignmentClientDiagnostics, Pipeline, "ConfigurationAssignmentCollection.GetAll", "value", null, cancellationToken);
        }
